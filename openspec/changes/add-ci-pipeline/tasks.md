...
- [ ] 1.2 `npx prisma generate`, `npm run typecheck` y `npm run lint` como pasos siguientes. Validación: un typo introducido a propósito en un archivo `.ts` hace fallar el job en el paso de typecheck, no antes ni después.
